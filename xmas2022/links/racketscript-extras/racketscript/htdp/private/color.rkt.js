...
var let_result4729 = M0.make_struct_type($rjs_core.PrimitiveSymbol.make("color"), false, 4, 0, 255, M0.rnull, false, false, $rjs_core.Pair.makeList(0, 1, 2, 3), false, $rjs_core.PrimitiveSymbol.make("color"));
var struct_3220 = let_result4729.getAt(0);
var make_3221 = let_result4729.getAt(1);
var __p3222 = let_result4729.getAt(2);
var __ref3223 = let_result4729.getAt(3);
var __set_bang_3224 = let_result4729.getAt(4);
var let_result4730 = M0.values(struct_3220, make_3221, __p3222, M0.make_struct_field_accessor(__ref3223, 0, $rjs_core.PrimitiveSymbol.make("red")), M0.make_struct_field_accessor(__ref3223, 1, $rjs_core.PrimitiveSymbol.make("green")), M0.make_struct_field_accessor(__ref3223, 2, $rjs_core.PrimitiveSymbol.make("blue")), M0.make_struct_field_accessor(__ref3223, 3, $rjs_core.PrimitiveSymbol.make("alpha")));
var struct_color = let_result4730.getAt(0);
var color1 = let_result4730.getAt(1);
var color_p = let_result4730.getAt(2);
var color_red = let_result4730.getAt(3);
var color_green = let_result4730.getAt(4);
var color_blue = let_result4730.getAt(5);
var color_alpha = let_result4730.getAt(6);
var cl4731 = function(a3225, b3226, c3227) {
    return color1(a3225, b3226, c3227, 255);
};
var cl4732 = function(a3228, b3229, c3230, d3231) {
    return color1(a3228, b3229, c3230, d3231);
};
var __color = $rjs_core.attachProcedureArity(function() {
    ...
    if (fixed_lam4733 !== undefined) {
        return fixed_lam4733.apply(null, arguments);
    } else {
        return M0.error($rjs_core.UString.make("case-lambda: invalid case"));
    }
}, [3, 4]);
var string__gt_color = function(color_string3232) {
    return __times_color_table_times_[M0.string_downcase(color_string3232)];
};
var color__gt_web_color = function(color3233) {
    return M0.format($rjs_core.UString.make("rgba(~a,~a,~a,~a)"), color_red(color3233), color_green(color3233), color_blue(color3233), color_alpha(color3233));
};
var string__gt_web_color = function(str3234) {
    return color__gt_web_color(string__gt_color(str3234));
};
